        ...
        'sql_Input_BallSignature'=> [
            ...
            'query_insert'  => [
                'query' => 'INSERT INTO tbl_Lottery_Numbers (twitter_user, draw_date, draw_type, balls_signature, entry_submition)
                            VALUES (:lotto_twitter_user_name, :lotto_draw_date, :lotto_draw_type, :lotto_balls_signature, :lotto_entry_submition)',
                'params'=> ['lotto_twitter_user_name', 'lotto_draw_date', 'lotto_draw_type', 'lotto_balls_signature','lotto_entry_submition']
            ],
            'query_update'  => [
                'query' => 'UPDATE tbl_Lottery_Numbers
                            SET balls_signature =:lotto_balls_signature, entry_submition=:lotto_entry_submition 
                            WHERE draw_date =:lotto_draw_date
                            AND draw_type =:lotto_draw_type',
                'params'=> ['lotto_draw_date','lotto_draw_type']
            ]
